...
const Chat = ({ favorites, searchTerm, setSearchTerm }) => {
        ...
        try {
            if (otherUserId) {
                ...
                if (!otherUserError && otherUserData) {
                    ...
                    setOtherUserName(`${otherUserData.first_name} ${otherUserData.last_name}`);
    ...
    }, [currentUser, conversationId, fetchMessages, fetchOtherUserProfile, fetchItemDetails]);
                ...
                <div className="bg-white border-b border-gray-200 p-4 shadow-sm">
                    <div className="flex items-center space-x-4 max-w-7xl mx-auto">
                        ...
                        <Avatar className="w-12 h-12 border-2 border-white shadow-sm">
                            <AvatarImage
                                src={otherUserProfile?.face_image_url}
                                alt={otherUserName}
                            />
                ...
                <div className="flex-1 overflow-hidden flex flex-col bg-gradient-to-b from-white to-orange-50/30 h-[calc(100%-140px)]">
                    {loading ? (
                        ...
                        <div className="flex-1 p-6 space-y-6 max-w-7xl mx-auto w-full">
                            {[...Array(8)].map((_, index) => (
                                <div key={index} className={`flex ${index % 2 === 0 ? 'justify-start' : 'justify-end'} space-x-3`}>
                                    {index % 2 === 0 && (
                                        <Skeleton className="w-10 h-10 rounded-full" />
                                    )}
                                    <div className={`max-w-md ${index % 2 === 0 ? 'bg-gray-100' : 'bg-orange-500'} rounded-2xl p-4`}>
                                ...
                                <div className="flex-1 flex flex-col items-center justify-center text-center space-y-4 h-full">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 max-w-sm">
                                            Start the conversation by sending a message about {itemTitle}
                                        </p>
                                    </div>
                                </div>
                            ) : (
                                                            ...
                                                            {isUploading && (
                                                                <div className="absolute inset-0 bg-black/50 rounded-xl flex items-center justify-center backdrop-blur-sm">
                                                                    <div className="text-white text-center">
                                                                        ...
                                                                        <p className="text-sm mt-2 font-medium">Sending...</p>
                                                                    </div>
                                                                </div>
                                                            )}
                                                        </div>
