...
function Home() {
  ...
  const hasActiveFilters =
    selectedCategoryId !== "" || selectedLocation !== "" || priceRange[0] !== 0 || priceRange[1] !== maxPrice
    ...
    <div className="bg-background min-h-screen">
        ...
        <div className="px-4 md:px-8 lg:px-16 xl:px-24 py-4">
          ...
          <div className="hidden md:flex items-center gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-3 min-w-[280px]">
              <span className="text-sm font-medium text-foreground whitespace-nowrap">Price:</span>
      ...
      <div className="px-4 md:px-8 lg:px-16 xl:px-24 mt-8">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-3xl md:text-4xl font-bold text-foreground tracking-tight">Available Items</h1>
