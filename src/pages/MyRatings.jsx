...
import { getExistingItemReview, saveItemReview } from "@/lib/reviews";
...
export default function MyRatings() {
    ...
    const fetchData = async () => {
        ...
        try {
            setLoading(true);
            const [{ data: rentals, error: e1 }, { data: reviews, error: e2 }] =
                await Promise.all([
                    supabase
                    ...
                    supabase
                        .from("reviews")
                        .select(
                            "rental_id, reviewer_id, rating, comment, created_at"
                        )
            ...
            <div className="max-w-5xl mx-auto px-6 py-8 space-y-8">
                <div className="space-y-2">
                    ...
                    <p className="text-[#1E1E1E]/60 text-lg">
                        Review your completed rentals and share your experience
                    </p>
                </div>
                            ...
                            <div className="col-span-full flex flex-col items-center justify-center py-20 space-y-4">
                                ...
                                <div className="text-center space-y-2">
                                    ...
                                    <p className="text-[#1E1E1E]/60">
                                        Once you complete a rental, you'll be
                                        able to leave a review here
                                    </p>
                                </div>
                            </div>
                        ) : (
                                    ...
                                    <CardHeader className="pb-4">
                                        <CardTitle className="text-lg font-semibold text-[#1E1E1E] flex items-center gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="truncate text-pretty leading-relaxed">
                                                    {r.items?.title || "Item"}
                                                </div>
        ...
        <div className="space-y-4">
            <div className="flex items-center gap-3 p-4 bg-green-50 border border-green-200 rounded-lg">
                ...
                <Button
                    ...
                    className="cursor-pointer border-[#FFAB00] text-[#FFAB00] hover:bg-[#FFAB00]/10"
                >
                    Edit
                </Button>
            </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-2">
                ...
                <Button
                    ...
                    className="flex-1 bg-[#FFAB00] hover:bg-[#FF9500] text-[#1E1E1E] font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg active:scale-[0.98]"
                >
                    {submitting ? (
...
function RatingForm({ itemId, rentalId, revieweeId, userId, onUpdated }) {
    const [submitting, setSubmitting] = useState(false);
