...
export default function PendingItems() {
  ...
  `)
    ...
    const approve = async (id) => {
        setActionId(id);
        try {
            // Get item details before update for notification
            ...
            try {
                ...
                await ItemNotifications.notifyItemStatusChange(
                    itemData.user_id,
                    id,
                    itemData.title,
                    true // approved = true
                                ...
                                {filterName && (
                                    <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#FFAB00]/10 text-[#FFAB00] rounded-full text-sm font-medium">
                                        ...
                                        <button
                                            ...
                                            className="hover:bg-[#FFAB00]/20 rounded-full p-0.5"
                                        >
                                            ✕
                                        </button>
                                    </span>
